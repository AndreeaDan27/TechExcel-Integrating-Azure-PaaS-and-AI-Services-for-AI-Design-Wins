...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, 
        [Description("The date and time")] DateTime dt
        )
    {
    ...
    [KernelFunction]
    [Description("Get all bookings with no hotel rooms assigned.")]
    ...
    [KernelFunction]
    [Description("Get all bookings with multiple rooms assigned.")]
